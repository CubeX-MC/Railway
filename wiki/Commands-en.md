...
| `/rw line setstatus <line_id> <normal&#124;suspended&#124;maintenance>` | Set operational status |
...
| `/rw line protect <line_id> <on&#124;off>` | Toggle rail protection |
...
| `/rw stop link <allow&#124;deny> <stop_id> <line_id>` | Manage line link whitelist |
